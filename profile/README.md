...
| # | 에이전트 | 역할 | 주요 입출력 |
| :---: | :--- | :--- | :--- |
| 1 | **Crawl Agent** | 주요 신문사 뉴스 수집 | 키워드 → 원문 기사 목록 |
| 2 | **Cluster Agent** | 유사 기사 클러스터링 및 이슈 그룹화 | 원문 목록 → 이슈 클러스터 |
| 3 | **Evidence Agent** | 클러스터별 핵심 근거·인용문 추출 | 클러스터 → 근거 풀(evidence pool) |
| 4 | **Issue Agent** | 이슈 배경 요약 및 맥락 구성 | 근거 풀 → 이슈 배경 요약 |
| 5 | **Writer Agent** | 미디어스 스타일 비평 기사 생성 | 이슈 배경 → 초안 기사 |
| 6 | **Judge Agent** | 실제 미디어스 기사와 유사도 평가 및 피드백 | 초안 → 최종 기사 / 재생성 트리거 |
